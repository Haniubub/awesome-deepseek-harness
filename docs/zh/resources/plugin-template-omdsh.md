...
description: "基于原 turtle-ui 官方仓库创建的插件模板。"
...
- [GitHub 仓库](https://github.com/omdsh-dev/plugin-template)
- [完整 README](https://github.com/omdsh-dev/plugin-template#readme)
- [返回plugin-template (omdsh-dev)所在分类](../examples.md)
