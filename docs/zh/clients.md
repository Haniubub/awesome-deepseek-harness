...
description: "DeepSeek Harness (dsh) 精选 clients (desktop & tui)：🔥 Top 10 与完整列表（60 条）。"
...
| [deepseek-harness-studio](resources/deepseek-harness-studio.md) | ⭐223 | DeepSeek Harness 零代码桌面端｜一键启动，支持 Windows 与 macOS；内置插件发现、热点插件推送、一键安装与管理、AI 智能推荐和视觉增强。 | ✅ 活跃 |
...
| 项目 | 星数 | 说明 | 状态 |
|---|---|---|---|
| [dsh-TUI](resources/dsh-tui.md) | ⭐1,782 | Claude Code 风格全屏交互终端插件：像素鲸鱼顶栏、实时状态行、思考流式展开、双击 Esc 回滚、上下文进度条 + TPS 仪表。 | ✅ 活跃 |
...
| [dsh-mobile](resources/dsh-mobile.md) | ⭐16 | Mobile client plugin (cordis + dsh.plugin.json). | ✅ 活跃 |
