...
description: "DeepSeek Harness with a Windows desktop build: an Electron shell over the dsh web profile, packaged as an installer"
...
## Author
**[RZX00](https://github.com/RZX00)**

## Links

- [GitHub Repository](https://github.com/RZX00/deepseek-harness-desktop)
- [Full README](https://github.com/RZX00/deepseek-harness-desktop#readme)
