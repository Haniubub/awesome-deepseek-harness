...
|---|---|---|---|---|
| 1 | [dsh-plugin-template](resources/dsh-plugin-template.md) | ⬆️ +5 | ⭐10 | Template for DeepSeek Harness plugin development. |
...
| 3 | [dsh-plugin-template](resources/dsh-plugin-template.md) | ⭐10 | Template for DeepSeek Harness plugin development. | ✅ active |
...
| [dsh-plugin-template](resources/dsh-plugin-template.md) | ⭐10 | Template for DeepSeek Harness plugin development. | ✅ active |
