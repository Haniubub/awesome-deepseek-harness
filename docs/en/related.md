...
| 6 | [open-managed-agents](resources/open-managed-agents.md) | ⭐237 | Open-source Claude Managed Agents API implementation and self-hosted Claude Tag-style agent runtime. | ✅ active |
| 7 | [Axern](resources/axern.md) | ⭐56 | Open-source sandboxes for AI agents: untrusted code execution and durable services. | ✅ active |
...
| [open-managed-agents](resources/open-managed-agents.md) | ⭐237 | Open-source Claude Managed Agents API implementation and self-hosted Claude Tag-style agent runtime. | ✅ active |
| [Axern](resources/axern.md) | ⭐56 | Open-source sandboxes for AI agents: untrusted code execution and durable services. | ✅ active |
